  ...
  return (
    <div>
      <div className="text-white text-center py-4">
        <h1 className="text-2xl font-bold pb-4">Envianos un mensaje</h1>
        <p className="font-thin text-xl ">Nos encantaría saber que tenes para decirnos</p>
      </div>
      <form>
        ...
        <div className="flex flex-col py-2">
          <textarea className="resize-none border-2 rounded-lg p-3 flex border-gray-300 text-sm text-black" rows={5} placeholder="Mensaje" resize="none"></textarea>
        </div>
